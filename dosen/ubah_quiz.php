...
if($_SERVER['REQUEST_METHOD']=='POST') {
   ...
   $sql = "UPDATE quiz SET judul='$judul', jumlah_soal='$jumlah_soal', waktu_pengerjaan_soal='$waktu_pengerjaan_soal', waktu_akhir_pengerjaan='$datetime' WHERE id_quiz='$id_quiz'";
